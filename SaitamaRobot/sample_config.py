...
class Config(object):
    ...
    TIME_API_KEY = "K1UZIZ5VJWJL"  # Get your API key from https://timezonedb.com/api
    WALL_API = (
        "awoo"  # For wallpapers, get one from https://wall.alphacoders.com/api.php
    )
    AI_API_KEY = "5935608297-fallen-usbk33kbsu"  # For chatbot, get one from https://coffeehouse.intellivoid.net/dashboard
